...
DSO_SOURCES_Vrtalk=$(AS_PROJECT_PATH)/Logical/VCShared/DataSources/Internal.dso \
	...
	$(AS_PROJECT_PATH)/Logical/VCShared/DataSources/DataSource_1.dso 
...
$(TEMP_PATH_ROOT_Vrtalk)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/VCShared/dso.DataSource_1.vco: $(AS_PROJECT_PATH)/Logical/VCShared/DataSources/DataSource_1.dso 
	 $(VCC) -f "$<" -o "$@" $(DSOFLAGS) $(VCCFLAGS_Vrtalk) -p Vrtalk -vcr 4265 -sfas

DPT_OBJECTS = $(TEMP_PATH_ROOT_Vrtalk)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/VCShared/dpt.DataPointList.vco
DSO_OBJECTS_Vrtalk=$(TEMP_PATH_ROOT_Vrtalk)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/VCShared/dso.Internal.vco $(TEMP_PATH_ROOT_Vrtalk)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/VCShared/dso.DataSource.vco $(TEMP_PATH_ROOT_Vrtalk)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/VCShared/dso.DataSource_1.vco 
