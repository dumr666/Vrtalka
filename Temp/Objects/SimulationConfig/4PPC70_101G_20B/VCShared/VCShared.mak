...
$(TEMP_PATH_ROOT_Vrtalk)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/VCShared/dso.hmiVariables.vco: $(AS_PROJECT_PATH)/Logical/VCShared/DataSources/hmiVariables.dso 
	 $(VCC) -f "$<" -o "$@" $(DSOFLAGS) $(VCCFLAGS_Vrtalk) -p Vrtalk -vcr 4265 -sfas

DPT_OBJECTS = $(TEMP_PATH_ROOT_Vrtalk)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/VCShared/dpt.DataPointList.vco
DSO_OBJECTS_Vrtalk=$(TEMP_PATH_ROOT_Vrtalk)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/VCShared/dso.Internal.vco $(TEMP_PATH_ROOT_Vrtalk)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/VCShared/dso.DataSource.vco $(TEMP_PATH_ROOT_Vrtalk)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/VCShared/dso.hmiVariables.vco 
